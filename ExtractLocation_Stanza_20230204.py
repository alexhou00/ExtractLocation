# -*- coding: utf-8 -*-
"""
Created on Sat Feb  4 22:30:22 2023
...
wordswPoS = [(word.text, word.xpos) for sent in doc.sentences for word in sent.words]
# formatted = wordswPoS
# print(*, sep='\n')
# [f'word: {word.text}\tupos: {word.upos}\txpos: {word.xpos}\tfeats: {word.feats if word.feats else "_"}' for sent in doc.sentences for word in sent.words]
'''
...
with open('pos_meaning_jieba.csv', 'r', encoding='utf-8-sig') as f:
    ...
    for row in csvreader:
        ...
        # print(row[1])
'''
formatted = [word.ljust(5,'　')+' '+pos.rjust(5, '　') for word, pos in wordswPoS]
# 
...
with open('results_stanza.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(formatted))